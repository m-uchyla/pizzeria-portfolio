...
const Ingredients = () => {
  return (
    <section className='xl:mt-[250px] lg:mt-[300px] md:mt-[250px] sm:mt-[120px] mt-[130px]'>
        <div className='flex sm:flex-row flex-col justify-between'>
            {ingredients.map((onePiece, index) => (
                <div key={onePiece.id} className='flex items-center sm:mb-0 mb-10'>
                    <img src={onePiece.img} className='md:w-[80px] sm:w-[50px] w-[60px] md:h-[80px] sm:h-[50px] h-[60px] sm:absolute relative lg:top-[730px] md:top-[780px] sm:top-[745px] sm:ml-[-5px]'/>
